...
hl.gesture({ fingers = 3, direction = "left", action = function() hl.exec_cmd("playerctl -p ncspot next") end })
hl.gesture({ fingers = 3, direction = "right", action = function() hl.exec_cmd("playerctl -p ncspot previous") end })
