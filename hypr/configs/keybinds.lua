...
hl.bind("SUPER + J", hl.dsp.exec_cmd("~/.config/rofi/scripts/config.sh"))
...
hl.bind("SUPER + G", hl.dsp.exec_cmd("~/.config/rofi/scripts/power-mode.sh"))
hl.bind("SUPER + SHIFT + D", hl.dsp.exec_cmd("discord"))
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd("~/.config/waybar/scripts/warp-toggle.sh toggle"))
...
-- ── Oturum Menüsü ────────────────────────────────────
hl.bind("SUPER + X", hl.dsp.exec_cmd("~/.config/rofi/scripts/powermenu.sh"))
