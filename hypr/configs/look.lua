...
local primary     = "rgb(fabd2f)"   -- Gruvbox Sarı (Aktif kenarlık için canlı)
local surface     = "rgb(282828)"   -- Gruvbox Koyu Arka Plan (Pasif kenarlık/yüzey)
local secondary   = "rgb(fe8019)"   -- Gruvbox Turuncu (Grup/İkincil aktif alanlar)
local error_color = "rgb(fb4934)"   -- Gruvbox Kırmızı (Hata/Kilitli alanlar)
